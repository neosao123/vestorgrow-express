...
module.exports = {
    save: async function (body) {
        ...
        try {
            ...
            let newSub = "Vestorgrow report for a post"
            let newContent = `${user.user_name} is reported this post please check this post on the given url ${process.env.FRONTEND_BASE_URL}/post/${body.postId}`
