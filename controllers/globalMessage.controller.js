const globalMessageServ = require("../services/globalMessage.service");
const fs = require("fs");
...
module.exports = {
  add: async function (req, res) {
    ...
    let faq = req.body;
    let result = await globalMessageServ.add(faq, req.currUser);
  ...
  edit: async function (req, res) {
    ...
    let oldData = await globalMessageServ.getDetail(req.body._id);
    let result = await globalMessageServ.edit(req.body);
    if (result) {
  ...
  delete: async function (req, res) {
    let result = await globalMessageServ.delete(req.params.id);
  ...
  listAll: async function (req, res) {
    let result = await globalMessageServ.listAll(req.body, req.currUser);
    utils.sendResponse(result, req, res);
  },
  deleteMessage: async function (req, res) {
    let result = await globalMessageServ.deleteMessage(req.body, req.currUser);
    utils.sendResponse(result, req, res);
  },
  markAsRead: async function (req, res) {
    let result = await globalMessageServ.markAsRead(req.body, req.currUser);
    utils.sendResponse(result, req, res);
  },

  getDetail: async function (req, res) {
    let result = await globalMessageServ.getDetail(req.params.id);
    utils.sendResponse(result, req, res);
  },
};
